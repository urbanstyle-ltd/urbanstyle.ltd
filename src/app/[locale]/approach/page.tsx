...
const CONTENT: Record<string, PageContent> = {
  ...
  uk: {
    tabs: {
      learners: "Для учасників",
      employers: "Для роботодавців",
      methodology: "Методологія",
    },
    zoom: { show: "Показати всі деталі", hide: "Сховати деталі" },
    sharedCta: {
      bookCallTitle: "15-хв. зустріч Google Meet з Алеком Козловим",
      bookCallDesc: "Зустріч із продюсером для обговорення ідей співпраці.",
      bookCallBtn: "Забронювати зустріч (Calendly)",
      contactInfo: "Алек Козлов \u00b7 ak@ettevotluskeskus.ee \u00b7 +372 502 1033",
    },

    learners: {
      eyebrow: "Програма DACA",
      headline: "Від нуля до готового до роботи аналітика даних за 11\u00a0тижнів",
      subtitle:
        "Інтенсивна програма на основі симуляції, яка дає професійне портфоліо, реальні навички та впевненість у кар\u2019єрі.",
      stats: [
        { value: "11", label: "Тижнів" },
        { value: "200+", label: "Годин" },
        { value: "13", label: "Кредитів EAP" },
        { value: "66", label: "Контактних годин" },
        { value: "3", label: "Сесії / тиждень" },
        { value: "10", label: "Проєктів портфоліо" },
      ],
      whatYouGetTitle: "Що ви отримаєте",
      whatYouGetDesc:
        "Професійне GitHub портфоліо з 10 проєктами з аналітики даних, які роботодавці можуть оцінити. Не сертифікати на стіні \u2014 робочі артефакти, що доводять ваші навички.",
      teamTitle: "Ви не студент \u2014 ви член команди",
      teamDesc:
        "З першого дня ви працюєте аналітиком даних в UrbanStyle \u2014 симульованому естонському модному стартапі. Реальні дані, реальні бізнес-задачі, реальні персонажі, які дають завдання та зворотний зв\u2019язок.",
      values: [
        { icon: "\u{1F4CA}", title: "SQL \u2192 Python", desc: "Від запитів до баз даних до автоматизації аналізу з pandas та API." },
        { icon: "\u{1F916}", title: "Навички AI", desc: "Навчіться співпрацювати з AI як професійній компетенції." },
        { icon: "\u{1F91D}", title: "Командна робота", desc: "Працюйте у постійних командах, що моделюють реальний аналітичний відділ." },
        { icon: "\u{1F680}", title: "Готовність до кар\u2019єри", desc: "Завершіть із професійним GitHub портфоліо та кар\u2019єрними матеріалами." },
      ],
      assessmentTitle: "Оцінювання: тільки портфоліо",
      assessmentDesc:
        "Жодних традиційних іспитів. Зараховано/Не зараховано на основі портфоліо: 70% відвідуваність, 8\u201310 проєктів, захист фінального проєкту.",
      badges: ["13 кредитів EAP", "Знак якості HAKA", "Кандидат на мікрокредит"],
      ctaEyebrow: "Прийом відкрито",
      ctaHeadline: "Перший потік починається 23\u00a0березня\u00a02026",
      ctaButton: "Подати заявку",

      accordions: {
        weekMap: "Карта тем 11 тижнів",
        weeklyFlow: "Тижневий ритм (спіральне навчання)",
        aiSkills: "Прогресія навичок AI",
        techStack: "Технологічний стек",
        careerChanger: "Підтримка зміни кар\u2019єри",
      },
      weekMapItems: [
        { week: "0", topic: "Онбординг та налаштування" },
        { week: "1", topic: "Основи SQL (SELECT, WHERE, ORDER BY)" },
        { week: "2", topic: "Очищення даних SQL (NULL, дублікати)" },
        { week: "3", topic: "SQL JOIN-и (INNER, LEFT, RIGHT)" },
        { week: "4", topic: "Агрегація SQL (GROUP BY, HAVING, CTE)" },
        { week: "5", topic: "Дизайн візуалізації (Power BI / Plotly)" },
        { week: "6", topic: "Створення дашбордів та сторітелінг даних" },
        { week: "7", topic: "Python pandas та numpy" },
        { week: "8", topic: "Python API та автоматизація (Supabase)" },
        { week: "9", topic: "Підготовка до кар\u2019єри (CV, LinkedIn, співбесіда)" },
        { week: "10", topic: "Захист портфоліо та випуск" },
      ],
      weeklyFlowIntro:
        "Кожен тиждень слідує спіральному патерну, де одна тема вивчається з різних перспектив:",
      weeklyFlowSteps: [
        { label: "Самостійна робота (Перспектива A)", desc: "Самостійне вивчення з ієрархічними циклами 4C" },
        { label: "Сесія 1: Ментор (Перспектива B)", desc: "Живе викладання додає новий ракурс, методологія 4C" },
        { label: "Сесія 2: Групова робота (A+B)", desc: "Команди синтезують обидві перспективи на практиці" },
        { label: "Сесія 3: Демо + ретро", desc: "Представлення результатів, зворотний зв\u2019язок, ретроспектива" },
      ],
      aiIntro:
        "AI-співпраця розглядається як 6-та ключова компетенція, що розвивається прогресивно за фреймворком Shu-Ha-Ri:",
      aiProgression: [
        { stage: "W0\u20131", level: "Знайомство", desc: "NotebookLM, запитання до AI" },
        { stage: "W2\u20133", level: "Помічник", desc: "Налагодження, перевірка результатів AI" },
        { stage: "W4\u20135", level: "Ко-пілот", desc: "Генерація коду, критична оцінка" },
        { stage: "W6\u20137", level: "Директор", desc: "Делегування, prompt engineering" },
        { stage: "W8\u20139", level: "Підсилювач команди", desc: "AI у груповій роботі" },
        { stage: "W10", level: "Демонстратор", desc: "Демонстрація використання AI у портфоліо" },
      ],
      careerIntro:
        "DACA створена для тих, хто змінює кар\u2019єру. Ваш існуючий професійний досвід \u2014 перевага, а не обмеження.",
      careerPoints: [
        "На ринку DA Естонії 56+ відкритих позицій, і він зростає",
        "Симуляція UrbanStyle цінує різноманітність перспектив",
        "На 9-му тижні \u2014 \u2018ага-момент\u2019: посібник з найму описує ВАС",
        "Кар\u2019єрні матеріали: шаблон CV, оптимізація LinkedIn, підготовка до співбесіди",
        "Оцінювання на основі портфоліо означає жодних традиційних іспитів",
      ],
    },

    employers: {
      eyebrow: "Для організацій",
      headline: "Підвищте кваліфікацію команди в аналітиці даних \u2014 без порушення операцій",
      subtitle:
        "Акредитована програма на основі симуляції, яка перетворює ваших співробітників на впевнених аналітиків даних.",
      stats: [
        { value: "15", label: "Потоків завершено" },
        { value: "13", label: "Кредитів EAP" },
        { value: "66", label: "Контактних годин" },
      ],
      qualityBadges: ["Знак якості HAKA", "Кандидат на мікрокредит", "13 кредитів EAP"],
      qualityTitle: "Акредитована та з гарантією якості",
      qualityDesc:
        "DACA має знак якості HAKA та є кандидатом на мікрокредит. Ваші співробітники отримують кваліфікацію з реальною академічною вагою \u2014 13 кредитів EAP, 66 контактних годин.",
      learnTitle: "Чому навчаться ваші співробітники",
      learnItems: [
        { label: "SQL та бази даних", desc: "Запити, очищення та аналіз реляційних даних" },
        { label: "Візуалізація даних", desc: "Power BI, Plotly та сторітелінг даних" },
        { label: "Python та pandas", desc: "Автоматизація аналізу та робота з API" },
        { label: "AI-співпраця", desc: "Використання AI-інструментів як професійної навички" },
        { label: "Сторітелінг даних", desc: "Презентація інсайтів для прийняття рішень" },
        { label: "Побудова портфоліо", desc: "Професійне портфоліо на GitHub" },
      ],
      values: [
        { icon: "\u{1F3AF}", title: "Релевантність роботі", desc: "Навчальна програма побудована на реальних бізнес-сценаріях \u2014 навички застосовні одразу." },
        { icon: "\u23F0", title: "Мінімальне порушення", desc: "3 сесії на тиждень, поєднання самостійної та живої роботи." },
        { icon: "\u2705", title: "Гарантія якості", desc: "Знак якості HAKA, кандидат на мікрокредит, 13 акредитованих кредитів EAP." },
        { icon: "\u{1F4B0}", title: "Можливості фінансування", desc: "Доступні можливості фінансування для відповідних організацій та учасників." },
      ],
      simTitle: "Чому навчання на основі симуляції?",
      simDesc:
        "Учасники працюють як аналітики даних в UrbanStyle, вирішуючи реалістичні бізнес-задачі з реальними даними. Навички переносяться безпосередньо на роботу, бо контекст відображає реальні організації.",
      ctaTitle: "Направте свою команду в DACA",
      ...
      accordions: {
        ...
        quality: "Якість та акредитація",
        schedule: "Розклад та формат",
        skills: "Карта навичок",
        simulation: "Чому симуляційне навчання працює",
      },
      roiIntro:
        "Співробітники отримують одразу застосовні навички через симуляційне навчання з реальними бізнес-даними.",
      roiPoints: [
        "200+ годин структурованого навчання за 11 тижнів",
        "10 проєктів портфоліо з відчутними бізнес-результатами",
        "SQL, Python, візуалізація та навички AI",
        "Співробітники працюють у командах, що моделюють реальні аналітичні відділи",
        "Доступні можливості фінансування для відповідних організацій",
      ],
      qualityAccordionP1:
        "Програма має знак якості HAKA та є кандидатом на мікрокредит з 13 кредитами EAP (Європейська система перезарахування кредитів).",
      qualityAccordionP2:
        "Оцінювання на основі портфоліо (Зараховано/Не зараховано), вимагає 70% відвідуваності та 8\u201310 поданих проєктів із захищеним фінальним проєктом.",
      scheduleIntro: "3 живі сесії на тиждень (по 90 хвилин), плюс самостійна робота:",
      scheduleSessions: [
        { day: "Вівторок", type: "Менторська сесія", desc: "Навчання під керівництвом експерта" },
        { day: "Середа", type: "Групова робота", desc: "Автономна командна практика" },
        { day: "Чт/Пт", type: "Демо + ретро", desc: "Презентації та зворотний зв\u2019язок" },
      ],
      skillsMap: [
        { skill: "SQL та запити до баз даних", weeks: "Тижні 1\u20134" },
        { skill: "Візуалізація даних та сторітелінг", weeks: "Тижні 5\u20136" },
        { skill: "Python та автоматизація", weeks: "Тижні 7\u20138" },
        { skill: "AI-співпраця", weeks: "Увесь період" },
        { skill: "Портфоліо та кар\u2019єрна готовність", weeks: "Тижні 9\u201310" },
      ],
      simulationP1:
        "Учасники працюють як аналітики даних в UrbanStyle \u2014 реалістичному естонському модному стартапі з реальними даними, реальними персонажами та реальними бізнес-задачами.",
      simulationP2:
        "Це означає, що навички переносяться безпосередньо на робоче місце. Співробітники не вивчають абстрактну теорію \u2014 вони практикують вирішення задач, ідентичних тим, що є у вашій організації.",
    },

    methodology: {
      eyebrow: "Педагогіка",
      headline: "Ми не продаємо інформацію \u2014 вона безкоштовна в інтернеті. Ми продаємо трансформаційний досвід.",
      stats: [
        { value: "4", label: "Основні принципи" },
        { value: "11", label: "Тижнів симуляції" },
        { value: "100%", label: "Практична робота" },
      ],
      simTitle: "Навчання на основі симуляції",
      simDesc:
        "Кожна вправа, набір даних та персонаж належить UrbanStyle \u2014 симульованому естонському модному стартапу. Учасники не вивчають аналітику даних; вони практикують її у реалістичному контексті, що формує переносні навички.",
      fourCompTitle: "Архітектура чотирьох компонентів",
      components: [
        {
          num: "1",
          name: "Менторство",
          color: "bg-slate-blue",
          desc: "Живі менторські сесії за методологією 4C. Під керівництвом експерта, інтерактивні, на основі викликів.",
          required: true,
        },
        {
          num: "2",
          name: "Портфоліо",
          color: "bg-sage",
          desc: "ЄДИНИЙ компонент оцінювання. 10 проєктів для побудови професійного GitHub портфоліо.",
          required: true,
        },
        {
          num: "3",
          name: "Підручники",
          color: "bg-burnt-orange",
          desc: "Два обов\u2019язкові підручники: \u201cPython for Data Analysis\u201d (McKinney) та \u201cStorytelling with Data\u201d (Knaflic).",
          required: true,
        },
        {
          num: "4",
          name: "Каталог е-навчання",
          color: "bg-limestone",
          desc: "Добровільні додаткові ресурси. Ніколи не оцінюються, ніколи не на сертифікаті.",
          required: false,
          voluntaryLabel: "Добровільно",
        },
      ],
      diffTitle: "Ключові відмінності",
      differentiators: [
        { icon: "\u{1F3AD}", title: "На основі симуляції", desc: "Кожна вправа використовує дані UrbanStyle \u2014 реалістичні, послідовні та захопливі." },
        { icon: "\u{1F504}", title: "Спіральне навчання", desc: "Кожна тема переглядається з різних перспектив протягом сесій." },
        { icon: "\u{1F4D6}", title: "Метод 4C", desc: "Connect \u2192 Concept \u2192 Concrete \u2192 Conclusion у кожній навчальній одиниці." },
        { icon: "\u{1F94B}", title: "Shu-Ha-Ri", desc: "Прогресія від копіювання до адаптації та інновації за 11 тижнів." },
        { icon: "\u{1F4BC}", title: "Портфоліо-першим", desc: "Оцінювання на 100% базується на портфоліо. Зараховано/Не зараховано. Без іспитів." },
        { icon: "\u{1F916}", title: "AI як 6-та компетенція", desc: "AI-співпраця викладається як навичка, а не просто інструмент." },
      ],
      rhythmTitle: "Тижневий ритм: спіральне навчання",
      rhythmDesc:
        "Кожна діяльність додає нову перспективу на ту саму тему. До кінця кожного тижня концепцію досліджено з боку самостійної роботи, менторства, командної роботи та демонстрації.",
      rhythmSteps: [
        { step: "01", title: "Самостійна робота", subtitle: "Перспектива A", desc: "Самостійне дослідження з циклами 4C" },
        { step: "02", title: "Менторська сесія", subtitle: "Перспектива B", desc: "Експерт додає новий ракурс, живе навчання" },
        { step: "03", title: "Групова робота", subtitle: "Синтез A + B", desc: "Команда застосовує обидві перспективи" },
        { step: "04", title: "Демо + ретро", subtitle: "Рефлексія", desc: "Презентація, зворотний зв\u2019язок, покращення" },
      ],
      contactTitle: "Запитання щодо нашого підходу?",
      contactDesc: "Зверніться до продюсера програми Алека Козлова для детальної інформації.",

      accordions: {
        fourC: "Метод викладання 4C",
        groupWork: "Патерн групової роботи JAGA-TEE-KOGU-ESITLE",
        shuHaRi: "Прогресія Shu-Ha-Ri",
        aiCompetency: "AI як 6-та компетенція",
        portfolio: "Оцінювання портфоліо",
        careerChanger: "Дизайн для зміни кар\u2019єри",
        curriculum: "Структура навчальної програми",
        techStack: "Технологічний стек",
      },
      fourCIntro: "Кожна навчальна одиниця слідує циклу 4C:",
      fourCSteps: [
        { c: "Connect", desc: "Активація попередніх знань, зв\u2019язок із чимось знайомим" },
        { c: "Concept", desc: "Введення нової концепції з чітким поясненням" },
        { c: "Concrete", desc: "Негайне застосування через практичні вправи" },
        { c: "Conclusion", desc: "Рефлексія, підсумок та перехід до наступної теми" },
      ],
      fourCHierarchical:
        "Робочі зошити для самостійної роботи використовують ієрархічну 4C: кожна підконцепція (Osa) отримує власний повний цикл 4C, за яким слідує інтегративний синтез.",
      groupWorkIntro: "Вся групова робота Сесії 2 слідує універсальному 90-хвилинному патерну:",
      groupWorkSteps: [
        { step: "JAGA (Поділися)", desc: "Команда переглядає, що вивчили індивідуально, ділиться інсайтами" },
        { step: "TEE (Роби)", desc: "Спільна практична робота над викликом тижня" },
        { step: "KOGU (Збери)", desc: "Компіляція результатів, підготовка матеріалів" },
        { step: "ESITLE (Презентуй)", desc: "Демонстрація результатів групі, отримання зворотного зв\u2019язку" },
      ],
      shuHaRiIntro:
        "Запозичений з бойових мистецтв, цей фреймворк визначає зростання автономії протягом програми:",
      shuHaRiPhases: [
        { phase: "Shu (Копіюй)", weeks: "Тижні 0\u20133", desc: "Чітко слідуй інструкціям. Акцент на правильній техніці." },
        { phase: "Ha (Адаптуй)", weeks: "Тижні 4\u20137", desc: "Починай розуміти ЧОМУ. Модифікуй підходи з підтримкою." },
        { phase: "Ri (Інновуй)", weeks: "Тижні 8\u201310", desc: "Створюй власний підхід. Захищай рішення у портфоліо." },
      ],
      aiCompIntro:
        "AI-співпраця \u2014 це названа навичка, що розвивається протягом усієї програми. Вона слідує кривій Shu-Ha-Ri:",
      aiCompFootnote:
        "Починаючи з Тижня 4, кожен README портфоліо включає секцію \u201cВикористання AI\u201d (1\u20132 речення).",
      portfolioIntro: "Оцінювання на 100% базується на портфоліо (Зараховано/Не зараховано):",
      portfolioPoints: [
        "70% відвідуваності обов\u2019язково",
        "8\u201310 проєктів портфоліо подано",
        "Фінальний проєкт захищено перед колегами та менторами",
        "Базовий рівень (70%): Обов\u2019язковий для заліку",
        "Просунутий рівень (30%): Необов\u2019язковий поглиблений аналіз для швидших учасників",
        "Без традиційних іспитів, без оцінок \u2014 тільки Arvestatud (Зараховано) або Mittearvestatud (Не зараховано)",
      ],
      careerDesignIntro:
        "Програма спеціально розроблена для тих, хто змінює кар\u2019єру. Кожен елемент підкріплює, що існуючий професійний досвід \u2014 це перевага:",
      careerDesignPoints: [
        "Тиждень 0: Статистика ринку DA Естонії (56+ позицій, зростаючий попит)",
        "Тижні 1\u20138: Ротація ролей в UrbanStyle цінує різноманітність поглядів",
        "Тиждень 9: \u2018Ага-момент\u2019 \u2014 посібник з найму описує ВАС",
        "Тиждень 10: Засідання ради UrbanStyle як церемонія випуску",
      ],
      curriculumIntro: "6 спринтів за 11 тижнів:",
      curriculumSprints: [
        { sprint: "Спринт 0", weeks: "Тиждень 0", focus: "Онбординг" },
        { sprint: "Спринт 1", weeks: "Тижні 1\u20132", focus: "Основи SQL" },
        { sprint: "Спринт 2", weeks: "Тижні 3\u20134", focus: "Просунутий SQL" },
        { sprint: "Спринт 3", weeks: "Тижні 5\u20136", focus: "Візуалізація" },
        { sprint: "Спринт 4", weeks: "Тижні 7\u20138", focus: "Аналіз Python" },
        { sprint: "Спринт 5", weeks: "Тижні 9\u201310", focus: "Портфоліо та кар\u2019єра" },
      ],
      curriculumFootnote:
        "Навчальну програму підтримують два обов\u2019язкові підручники: \u201cPython for Data Analysis\u201d (McKinney) та \u201cStorytelling with Data\u201d (Knaflic).",
    },
  },
};
...
function useContent(): PageContent {
  ...
  return CONTENT[locale as "en" | "et" | "ru" | "lv" | "uk"] || CONTENT.en;
}
