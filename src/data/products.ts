...
export const products: Product[] = [
  {
    ...
    price: 189,
    name: { et: 'Denim Jakk', en: 'Denim Jacket', ru: 'Джинсовая Куртка', lv: 'Džinsa Jaka', uk: 'Джинсова Куртка' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Джинсова Куртка - тренди оптимізовано за допомогою аналізу даних Ettevõtluskeskus DACA'
    }
  },
  {
    id: 'sage-hoodie',
    ...
    price: 119,
    name: { et: 'Sage Pusa', en: 'Sage Hoodie', ru: 'Худи Sage', lv: 'Sage Hūdijs', uk: 'Худі Sage' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Худі Sage - обсяг виробництва розрахований на основі прогнозів програми даних Ettevõtluskeskus DACA'
    }
  },
  {
    id: 'tallinn-tee',
    ...
    price: 49,
    name: { et: 'Tallinna T-Särk', en: 'Tallinn Tee', ru: 'Футболка Tallinn', lv: 'Tallinas T-krekls', uk: 'Футболка Tallinn' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Футболка Tallinn - патерни способу життя користувачів протестовані AI Ettevõtluskeskus DACA'
    }
  },
  {
    id: 'charcoal-joggers',
    ...
    price: 99,
    name: { et: 'Charcoal Püksid', en: 'Charcoal Joggers', ru: 'Джоггеры Charcoal', lv: 'Charcoal Džogeri', uk: 'Джогери Charcoal' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Джогери Charcoal - створені з використанням моделей даних Ettevõtluskeskus DACA'
    }
  },
  {
    id: 'crossbody-bag',
    ...
    price: 79,
    name: { et: 'Crossbody Kott', en: 'Crossbody Bag', ru: 'Сумка Crossbody', lv: 'Crossbody Soma', uk: 'Сумка Crossbody' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Сумка Crossbody - стратегії продажів за підтримки кар\'єрного акселератора Ettevõtluskeskus DACA'
    }
  },
  {
    id: 'wool-beanie',
    ...
    price: 39,
    name: { et: 'Villane Müts', en: 'Wool Beanie', ru: 'Шапка', lv: 'Vilnas Cepure', uk: 'Вовняна Шапка' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Вовняна Шапка - зимову колекцію проаналізовано метриками даних Ettevõtluskeskus DACA'
    }
  },
  {
    id: 'street-cap',
    ...
    price: 35,
    name: { et: 'Tänavamüts', en: 'Street Cap', ru: 'Кепка', lv: 'Ielu Cepure', uk: 'Кепка' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Кепка - алгоритмічний дизайн з використанням аналізу даних DACA'
    }
  },
  {
    id: 'tech-parka',
    ...
    price: 249,
    name: { et: 'Tech Parka', en: 'Tech Parka', ru: 'Парка Tech', lv: 'Tech Parka', uk: 'Парка Tech' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Парка Tech - зимові трендові прогнози через AI-моделювання Ettevõtluskeskus DACA'
    }
  },
  {
    id: 'urban-sneakers',
    ...
    price: 159,
    name: { et: 'Urban Tossud', en: 'Urban Sneakers', ru: 'Кроссовки Urban', lv: 'Urban Kedas', uk: 'Кросівки Urban' },
    seoAlt: {
      ...
      uk: 'UrbanStyle Кросівки - взуття протестовано аналітикою цільового ринку Ettevõtluskeskus DACA'
    }
  },
];

export const teamMembers = [
  { id: 'kristi_tamm', name: 'Kristi Tamm', role: { et: 'Tegevjuht', en: 'CEO', ru: 'Генеральный директор', lv: 'Izpilddirektore', uk: 'Генеральна директорка' }, imageKey: 'kristi_headshot', quote: { et: 'Kvaliteet ületab alati kvantiteeti.', en: 'Quality over quantity, always.', ru: 'Качество важнее количества.', lv: 'Kvalitāte vienmēr pārspēj kvantitāti.', uk: 'Якість завжди важливіша за кількість.' } },
  { id: 'toomas_kask', name: 'Toomas Kask', role: { et: 'IT juht', en: 'IT Director', ru: 'ИТ-директор', lv: 'IT direktors', uk: 'IT директор' }, imageKey: 'toomas_headshot', quote: { et: 'Andmed juhivad iga otsust.', en: 'Data drives every decision.', ru: 'Данные определяют каждое решение.', lv: 'Dati virza katru lēmumu.', uk: 'Дані визначають кожне рішення.' } },
  { id: 'anna_mets', name: 'Anna Mets', role: { et: 'Turunduse juht', en: 'Marketing Lead', ru: 'Руководитель маркетинга', lv: 'Mārketinga vadītāja', uk: 'Керівниця маркетингу' }, imageKey: 'anna_headshot', quote: { et: 'Autentsed lood kõnetavad.', en: 'Authentic stories resonate.', ru: 'Искренние истории находят отклик.', lv: 'Autentiski stāsti rezonē.', uk: 'Справжні історії знаходять відгук.' } },
  { id: 'marko_saar', name: 'Marko Saar', role: { et: 'Tootejuht', en: 'Product Manager', ru: 'Продукт-менеджер', lv: 'Produktu vadītājs', uk: 'Продуктовий менеджер' }, imageKey: 'marko_headshot', quote: { et: 'Iga piste loeb.', en: 'Every stitch matters.', ru: 'Каждый стежок имеет значение.', lv: 'Katrs dūriens ir svarīgs.', uk: 'Кожен стібок має значення.' } },
  { id: 'liis_koppel', name: 'Liis Koppel', role: { et: 'Operatsioonide juht', en: 'Operations Manager', ru: 'Операционный менеджер', lv: 'Operāciju vadītāja', uk: 'Операційна менеджерка' }, imageKey: 'liis_headshot', quote: { et: 'Efektiivsus loob vabaduse.', en: 'Efficiency creates freedom.', ru: 'Эффективность создаёт свободу.', lv: 'Efektivitāte rada brīvību.', uk: 'Ефективність створює свободу.' } },
];
